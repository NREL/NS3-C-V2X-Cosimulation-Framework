...
{
  std::cout << "\n\n\n\nlte-ue-rrc.cc:276: deleting sidelink radio bearer" << std::endl;
...
LteUeRrc::DoActivateSidelinkRadioBearer (uint32_t group, bool tx, bool rx)
{
  ...
  // std::cout << "m_state: " << m_state << std::endl; // always "1" = IDLE_CELL_SEARCH
  switch (m_state)
    {
    case IDLE_START:
    case IDLE_CELL_SEARCH:
...
LteUeRrc::DoDeactivateSidelinkRadioBearer (uint32_t group)
{
  ...
  std::cout << "\n\n\n\nlte-ue-rrc:1195: trying to delete bearer" << std::endl;
  ...
  if (m_sidelinkConfiguration->DeleteSidelinkRadioBearer (m_sidelinkConfiguration->m_sourceL2Id, group))
    {
      ...
      std::cout << "\n\n\n\nlte-ue-rrc:1226: could not delete bearer" << std::endl;
  }
}
