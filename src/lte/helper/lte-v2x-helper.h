...
// Added: McManus 11/29/2023

  /**
   * Schedule the DE-activation of a sidelink bearer (to emulate dynamic topology)
   * \param activationTime The time to disable the sidelink bearer
   * \param ues The list of UEs where the bearer must be deactivated
   * \param tft Traffic flow template for the bearer (i.e. multicast address and group)
   */
  void DeactivateSidelinkBearer (Time deactivationTime, NetDeviceContainer ues, Ptr<LteSlTft> tft);

  /**
   * Deactivation of a sidelink bearer
   * \param ues The list of UEs where the bearer must be deactivated
   * \param tft Traffic flow template for the bearer (i.e. multicast address and group)
   */
  void DoDeactivateSidelinkBearer (NetDeviceContainer ues, Ptr<LteSlTft> tft);
